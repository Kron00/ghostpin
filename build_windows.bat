@echo off
:: UNMAINTAINED. This build is known not to produce a working app: it omits the
:: userspace_tunnel hidden import and the apple-compress / pyimg4 metadata that
:: the iOS 17.4+ connection path needs. Kept as a starting point only.
